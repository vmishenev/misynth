...
public:    
    ...
    br_status mk_app_core(family_id fid, decl_kind k, unsigned num_args, expr * const * args, expr_ref & result);
    br_status mk_app_core(func_decl* f, unsigned num_args, expr * const * args, expr_ref & result) {
        return mk_app_core(f->get_family_id(), f->get_decl_kind(), num_args, args, result);
    }
