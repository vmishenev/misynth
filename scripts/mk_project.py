...
def init_project_def():
    ...
    add_lib('misynth', ['muz', 'clp', 'tab', 'rel', 'bmc', 'ddnf', 'spacer', 'ast'], 'misynth')
    add_lib('portfolio', ['smtlogic_tactics', 'sat_solver', 'ufbv_tactic', 'fpa_tactics', 'aig_tactic', 'fp',  'fd_solver', 'qe','sls_tactic', 'subpaving_tactic', 'misynth'], 'tactic/portfolio')
